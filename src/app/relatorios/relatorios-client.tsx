...
export function RelatoriosClient({ initialReports }: RelatoriosClientProps) {
  ...
  async function handleSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast.error(typeof result.error === "string" ? result.error : "Erro de validação.");
      }
    } catch {
  ...
  return (
    <div className="page-stack">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-[1fr_360px] gap-5">
        <div className="app-card p-6">
          <SectionHeader
            ...
            description="Preencha os indicadores do mês para gerar relatórios consistentes."
            className="mb-5"
          />
          ...
          >
            <div>
              ...
              <Input
                ...
                className={cn("mt-1.5 h-10 rounded-xl bg-surface-high border-0 focus-visible:ring-2 focus-visible:ring-primary/20", formErrors.referenceMonth && "border border-destructive")}
              />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  className={cn("mt-1.5 h-10 rounded-xl bg-surface-high border-0 focus-visible:ring-2 focus-visible:ring-primary/20", formErrors.totalMembers && "border border-destructive")}
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateField("totalConversions", e.target.value)}
                  className={cn("mt-1.5 h-10 rounded-xl bg-surface-high border-0 focus-visible:ring-2 focus-visible:ring-primary/20", formErrors.totalConversions && "border border-destructive")}
                />
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateField("totalVisitors", e.target.value)}
                  className={cn("mt-1.5 h-10 rounded-xl bg-surface-high border-0 focus-visible:ring-2 focus-visible:ring-primary/20", formErrors.totalVisitors && "border border-destructive")}
                />
              ...
              <div>
                ...
                <Input
                  ...
                  onChange={(e) => updateField("totalBaptisms", e.target.value)}
                  className={cn("mt-1.5 h-10 rounded-xl bg-surface-high border-0 focus-visible:ring-2 focus-visible:ring-primary/20", formErrors.totalBaptisms && "border border-destructive")}
                />
            ...
            <div>
              ...
              <textarea
                ...
                className={cn("mt-1.5 w-full rounded-xl bg-surface-high border-0 p-3 text-sm text-foreground placeholder:text-muted-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/20 resize-none", formErrors.notes && "border border-destructive")}
              />
              <FieldError error={formErrors.notes} />
            </div>

            <div className="flex gap-3 pt-2">
              <Button type="reset" variant="outline" className="flex-1 h-10 rounded-xl border-border">
                Limpar Campos
              </Button>
        ...
        <div className="space-y-5">
          <div className="app-card p-5">
            <SectionHeader icon={Clock} title="Histórico de relatórios" className="mb-4" />
      ...
      <div className="app-card p-6">
        <SectionHeader icon={TrendingUp} title="Histórico de engajamento" className="mb-4" />
        <div className="flex items-end gap-3 h-44">
          {chartReports.length === 0 ? (
            ...
            chartReports.map((report) => {
              const maxMembers = Math.max(...chartReports.map((r) => r.totalMembers), 1);
              ...
              return (
                <div key={report.id} className="flex-1 flex flex-col items-center gap-1.5">
                  <div
